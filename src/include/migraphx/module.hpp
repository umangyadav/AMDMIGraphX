...
struct module
{
    ...
    instruction_ref add_instruction(const operation& op, module_ref mdl, std::vector<instruction_ref> args);
    ...
    instruction_ref insert_instruction(instruction_ref ins, const operation& op, module_ref mdl, std::vector<instruction_ref> args);
