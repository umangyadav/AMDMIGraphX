...
// template <class T>
// auto compute_shape_op(rank<1>, const T& x, const std::vector<shape>& inputs, const
// std::vector<module_ref>&)
...
// template <class T>
// shape compute_shape_op(rank<0>, const T& x, const std::vector<shape>&, const
// std::vector<module_ref>&)
// {
...
struct operation
{
    ...
    static shape private_detail_te_default_compute_shape(float,
                                                         ...
                                                         const std::vector<module_ref>& mod_args)
    {
        return detail::normalize_compute_shape_op(private_detail_te_self, inputs, mod_args);
    }
