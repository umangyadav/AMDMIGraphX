    ...
    static literal parse_tensor(const tensorflow::TensorProto& t)
    {
        ...
        if(!t.tensor_content().empty()) // has raw data
        {
            ...
            case tensorflow::DataType::DT_INT8:
                return literal{{shape::int8_type, dims}, s.data()};
        ...
        // case tensorflow::DataType::DT_UINT16:
        //     return create_literal(shape::uint16_type, dims, get_data_vals(t.int_val(),
        //     shape_size));
        // case tensorflow::DataType::DT_INT16:
        //     return create_literal(shape::int16_type, dims, get_data_vals(t.int_val(),
        //     shape_size));
        case tensorflow::DataType::DT_INT32:
