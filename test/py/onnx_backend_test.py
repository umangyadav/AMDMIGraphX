...
def create_backend_test(testname=None, target_device=None):
    ...
    if testname:
        ...
        backend_test.exclude(r'test_max_int16_cpu')
        backend_test.exclude(r'test_max_uint16_cpu')
        ...
        backend_test.exclude(r'test_min_int16_cpu')
        backend_test.exclude(r'test_min_uint16_cpu')
